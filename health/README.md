...
npm run cc:start -- clinic_history
# Make a testing call to create a record in the ledger
# Beware that the first call may fail with a timeout! Just happens the first time
hurl invoke clinic_history clinic_history_create "{\"name\":\"my first request\",\"id\":\"0001\",\"created\":0,\"modified\":0}"
```
...
npm run cc:package -- clinic_history org1
# Install to your blockchain - From the root of your project
hurl install clinic_history node -P ./chaincode-clinic_history
# Install in debug mode, this will run the chaincode server locally so you can debug
hurl install clinic_history node -P ./chaincode-clinic_history --debug

# Upgrade your existing chaincode - From the root of your project
hurl upgrade clinic_history node 1.2 -P ./chaincode-clinic_history
```
...
# Upgrade your existing chaincode - From the root of your project
npm run cc:upgrade -- clinic_history 1.2
```
